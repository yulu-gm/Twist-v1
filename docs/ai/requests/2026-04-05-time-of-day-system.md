...
| --- | --- | --- | --- | --- |
| `time-of-day` | 玩家能看到世界从 `Day 1 06:00` 开始连续推进，并触发昼夜视觉变化 | `docs/ai/system-standards/time-of-day.md` | `docs/ai/systems/time-of-day/2026-04-05-time-of-day-system.md` | 领域 |
| `scene-hud` | 玩家能在菜单栏或兼容 HUD 容器看到 `Day N HH:MM` | `docs/ai/system-standards/scene-hud.md` | `docs/ai/systems/scene-hud/2026-04-05-time-of-day-system.md` | 组件 |
